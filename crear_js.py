...
with open('/root/sistema_agenda/static/admin/js/autocompletar_requerimiento.js', 'w') as f:
    f.write(content)

with open('/root/sistema_agenda/gestion/static/admin/js/autocompletar_requerimiento.js', 'w') as f:
    f.write(content)

print("¡Ajustes aplicados con éxito!")
